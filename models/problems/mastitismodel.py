...
class MastitisModel(Problems):
    ...
    def __init__(self, cow_id, problem_name, date_diagnosed, date_treated, date_cured, is_right_front_affected, is_left_front_affected, is_right_back_affected, is_left_back_affected):
        super().__init__(cow_id, problem_name, date_diagnosed, date_treated, date_cured)
